...
import {MenuTreeOption, RoleDeptTree, RoleForm, RoleMenuTree, RoleQuery, RoleUserQuery, RoleVO} from './types'
...
export function menuTreeselect() {
	return request.get<ApiResponse<MenuTreeOption[]>>('/system/menu/treeselect')
}
...
/** 批量选择用户授权 */
export function authUserSelectAll(data: { roleId: number | string; userIds: (string | number )[] }) {
